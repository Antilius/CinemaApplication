...
public class ReturnButtonChangingTextColor extends ChangingPanelButtonWithText implements MouseListener,ActionListener {
    ...
    public ReturnButtonChangingTextColor(String user, String textInsideButton, JPanel panel_to_clear, int text_size, Color main_color, Color mouse_on_button_color, Color background_color) {
    ...
    public void mouseReleased(MouseEvent event) {
        if(event.getSource() == this){
            ...
            ((MainPanel)this.context).printThisAfterLogin(this.user, ((MainPanel)this.context).getWidth(),((MainPanel)this.context).getHeight());
